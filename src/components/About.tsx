...
const About: React.FC = () => {
  return (
    <section id="about" className="max-w-4xl min-h-screen mx-4 md:mx-auto">
      ...
      <div className="my-8">
        <p className="text-base text-muted-foreground text-justify font-OpenSans font-medium leading-loose">
          Hi, I&apos;m{" "}
          ...
          with over a year of experience crafting engaging and high-performance
          web applications. I specialize in building{" "}
          ...
          <strong className="text-orange-700 dark:text-orange-400">LMS,</strong>{" "}
